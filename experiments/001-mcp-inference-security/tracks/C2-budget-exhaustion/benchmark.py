...
FIELDS = (
    ...
    "false_denial_events",
    "safe_candidate_requests",
    "safe_reused_requests",
    "safe_reuse_rate",
    "task_progress",
    "task_completed",
    "downgrade_adequacy",
...
def simulate_trial(policy: str, workload: str, budget: float, criticality: str, trial: int) -> dict[str, object]:
    ...
    return {
        ...
        "safe_candidate_requests": safe_candidates,
        "safe_reused_requests": safe_reused,
        "safe_reuse_rate": round(safe_reused / safe_candidates if safe_candidates else 0.0, 6),
